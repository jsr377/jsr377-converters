...
public class FloatFormatterTest extends AbstractNumberFormatterTestCase<Float> {
    ...
    public static Stream<Arguments> where_pattern() {
        return Stream.of(
            ...
            Arguments.of(PATTERN_CURRENCY, 100f, "$100.00"),
            Arguments.of(PATTERN_PERCENT, 1f, "100%"),
            Arguments.of(null, 100f, "100.0"),
            Arguments.of("", 100f, "100.0"),
            Arguments.of("##.0", 20f, "20.0")
        );
    }
